...
describe('UNIT tests on the harmonic function', function () {
  ...
  describe('Test cases from file:', function () {
    askInput();
    it('askInput() is working', askInput(), (result) => {
      //NOT WORKING - function runs synchronous and not asynchronous as it should. didn't find solution yet. tried: Promises, awaits, done, ..
